    ...
    <main>
        ...
        <div class="mainContent">
            <div class="contentHeader">
                <div class="headerTitle">Tracks</div>
            ...
            <div class="allContents">
                ...
                <table>
                    ...
                    <?php
                        $qry = "SELECT * FROM tracks ORDER BY id DESC";
                        ...
                        while($row=mysqli_fetch_assoc($result)){
                            echo '
                                <tr>
                                    ...
                                    <td><a href="./editTrack.php?id='.$row['id'].'">Edit</a></td>
                                    <td><a href="../partials/deleteTrack.php?id='.$row['id'].'">Delete</a></td>
                                </tr>
                            ';
                        }
                    ?>
