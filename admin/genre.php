    ...
    <main>
        ...
        <div class="mainContent">
            <div class="contentHeader">
                <div class="headerTitle">Genre</div>
            ...
            <div class="allContents">
                ...
                <table>
                    ...
                    <?php
                        $qry = "SELECT * FROM genre ORDER by id DESC";
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            echo '
                                <tr>
                                    <td>'.$row['id'].'</td>
                                    <td>'.$row['title'].'</td>
                                    <td><a href="./editGenre.php?id='.$row['id'].'">Edit</a></td>
                                    <td><a href="../partials/deleteGenre.php?id='.$row['id'].'">Delete</a></td>
                                </tr>
                            ';
                        }
                    ?>
